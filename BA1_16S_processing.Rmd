...
# S-oxidizing taxa from Rempfert et al., 2017

```{r list-S-ox-taxa}
# input S-oxidizing taxa found in Rempfert et al., 2017

S_ox_taxa_oman <- c("Sulfuritalea", "Rhodocyclaceae", "Cupriavidus")
```
...
```{r S-ox-heat-fam-deeper, fig.width=7, fig.height=2}
ampli_OM17_thru_19_focus_samples_taxa_filtered %>%
  # remove samples taken prior to 2018
  filter(year_sampled > 2017) %>% 
# add column combining year and well
