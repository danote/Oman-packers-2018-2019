...
# S_ox_taxa_oman_all <- c("Sulfuritalea", "Rhodocyclaceae", "Cupriavidus", "Sulfolobales", "Thiobacilliaceae", "Beggiatoaceae", "Acidithiobacillus", "Aquaspirillum", "Aquifex", "Bacillus", "Methylobacterium", "Paracoccus", "Pseudomonas", "Starkeya", "Thermithiobacillus", "Xanthobacter", "Desulfobulbaceae", "Chromatiaceae", "Allochromatium", "Chlorobiaceae", "Rhodospirillaceae", "Lyngbya", "Aphanotece", "Microcoleus", "Phormidium", "Thiobacillus", "Thermothrix", "Chloroflexaceae", "Thiomicrospirales", "Sulfur")

# S_ox_taxa_oman <- c("Rhodocyclaceae", "Cupriavidus", "Desulfobulbaceae", "Thio", "thio", "Sulf", "sulf")

# S_ox_taxa_oman <- c("Rhodocyclaceae", "Cupriavidus", "Desulfobulbaceae", "Thiobacillus", "Acidiferrobacteraceae")

S_ox_taxa_oman <- c("Thiobacillus", "Acidiferrobacteraceae")

S_ox_taxa_oman <- c("ethyl")
```

```{r S-ox-heat, fig.width=8, fig.height=3.5}
ampli_OM18_thru_19_focus_samples_taxa_filtered_packer_interval_filter_diam %>% 
  ampli_heat_map(x_sample_group_col = packer_interval_filter_diam, taxa_selection_method = "custom_taxa_char_vector", custom_taxa_char_vector = S_ox_taxa_oman, plot_other_taxa_bin = FALSE, text_label_scalar = 100, text_label_decimal_places = 0, text_label_threshold = 0.01, text_label_zero = "n.r.", text_label_threshold_round_priority = "round", top_n = 50, facet_grid_sample_group_col = year_sampling_site) +
...
```{r S-ox-heat-fam-deeper, fig.width=7, fig.height=2.5}
ampli_OM18_thru_19_focus_samples_taxa_filtered_packer_interval_filter_diam %>%
...
```{r S-ox-heat-fam-genus, fig.width=7, fig.height=2.5}
ampli_OM18_thru_19_focus_samples_taxa_filtered_packer_interval_filter_diam %>%
  # concatenate taxa at family level and deeper
  mutate(tax_family_further = paste0("f__", Family, "; g__", Genus)) %>% 
  ampli_heat_map(x_sample_group_col = packer_interval_filter_diam, taxa_selection_method = "custom_taxa_char_vector", custom_taxa_char_vector = S_ox_taxa_oman, plot_other_taxa_bin = FALSE, text_label_scalar = 100, text_label_decimal_places = 0, text_label_threshold = 0.01, text_label_zero = "n.r.", text_label_threshold_round_priority = "round", top_n = 20, facet_grid_sample_group_col = year_sampling_site, y_taxa_col = tax_family_further) +
  ...
  scale_fill_gradient(name = "Read relative\nabundance / [%]", low = "white", high = "white", labels = label_percent(accuracy = 1, suffix = "")) +
  scale_x_discrete(name = "Depth of sampling interval / [m] and filter pore diameter / [µm]\ngrouped by year of sampling and well name", expand = c(0,0)) +
  scale_y_discrete(name = "Family and genus", expand = c(0,0)) +
