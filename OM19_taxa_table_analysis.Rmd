...
```{r load-data}
tax_table_fp <- 'data_output/20200526_tax_tab_DADA2_mctoolsr_OM19_Silva138_Bayes_packers.txt'
map_fp <- 'data_raw/Summary_metadata/meta_map_16S_OM19_packers.txt'
...
# input_filt <- filter_taxa_from_input(input_filt, at_spec_level = 1, taxa_to_remove = "NA") # no taxa not assigned at domain level in this dataset
```
...
Generate heat map
```{r heat-map-OM19-packers, fig.height=7, fig.width=8}
...
### Plot
```{r CH4-taxa-bar-OM19-packers, fig.width = 5, fig.height = 4, dpi=300}
# create plot
...
### Plot
```{r Hydrogenophaga-bar-OM19-packers, fig.width = 3, fig.height = 4, dpi=300}
# create plot
...
### Plot
```{r SCA_taxa_bar-OM19-packers, fig.width = 5, fig.height = 4, dpi=300}
# create plot
