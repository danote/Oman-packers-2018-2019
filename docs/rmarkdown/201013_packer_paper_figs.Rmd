...
shapes_all_sites_named <- c("Other Samail Ophiolite" = 20, "BA1A_2019_108-132" = 15, "BA1D_2019_45-75" = 17,  "BA1D_2019_102-132" = 19)
...
CD_plot <-
  ...
  # symbol styling
  scale_color_manual(name = "Sample ID", values = colors_all_sites_named, guide = guide_legend(title.position = "left")) +
  scale_shape_manual(name = "Sample ID", values = shapes_all_sites_named, guide = guide_legend(title.position = "left")) +
...
CH4_d13C_permil_VPDB, packer_site_year_interval) # select relevant data for CH4, C2H6, C3H8
...
alkanes_d13C_oman_wells_and_lit_plot <- ggplot() +
  ...
  # symbol styling
  scale_color_manual(name = NULL, values = colors_all_sites_named, guide = guide_legend(ncol = 2)) +
  scale_shape_manual(name = NULL, values = shapes_all_sites_named, guide = guide_legend(ncol = 2)) +
