...
shapes_all_packer_site_year_interval_named <- c("Other Samail Ophiolite" = 5, "BA1A_2019_108-132" = 15, "BA1D_2019_45-75" = 17,  "BA1D_2019_102-132" = 19, "BA1A_2019_0-30" = 18, "BA1A_2019_41-65" = 3, "BA1A_2018_55-66" = 4, "BA1A_2018_100-400" = 6)
colors_all_packer_site_year_interval_named <- c(
  "Other Samail Ophiolite" = "#999999", "BA1A_2019_108-132" = "#E69F00", "BA1D_2019_45-75" = "#56B4E9",  "BA1D_2019_102-132" = "#CC79A7", "BA1A_2019_0-30" = "#009E73", "BA1A_2019_41-65" = "#F0E442", "BA1A_2018_55-66" = "#0072B2", "BA1A_2018_100-400" = "#D55E00")
...
Si_pH_plot <- ggplot() +
  ...
  # points
  geom_point(data = data %>% filter(water_type == "Ca_OH" | water_type == "Mg_HCO3"),
    mapping =  aes(
    x = pH,
    y = Si_total_uM,
    shape = packer_site_year_interval,
  ...
  scale_color_manual(name = "Sample ID", values = colors_all_packer_site_year_interval_named, guide = guide_legend(ncol = 2)) +
  scale_shape_manual(name = "Sample ID", values = shapes_all_packer_site_year_interval_named, guide = guide_legend(ncol = 2)) +
  ...
  # annotations
    ...
    annotate("text", label = "5%", x = 12.7,  y = data_Leong_mix_all_endmembers_05_percent_mix %>% summarise(Si_umolal = min(Si_molal) * 1e6) %>% as.numeric(), angle = 0, color = "light blue", size = 3.2) +
